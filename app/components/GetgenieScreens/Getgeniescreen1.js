...
export default function Getgeniescreen1({ navigation }) {
        ...
        <View style={[css.section]}>
            <View style={[css.container, css.liteBlueBG]}>
                <View style={[css.flexDRSB]}>
                    <View style={[css.flexDRSB, css.img90]}>
                        ...
                        <TouchableHighlight style={[styles.categoryBtn]}><Text style={[styles.categoryBtnText]}>screen 1</Text></TouchableHighlight>
            ...
            <View style={[css.flexDR], { flexDirection: 'row', height: '100%' }}>
                <View style={{ backgroundColor: '#eff7fc', width: '30%', height: '100%' }}>
                    <TouchableOpacity style={{ backgroundColor: '#fff', flexDirection: 'row', padding: 5, paddingTop: 10, paddingBottom: 10, borderBottomColor: '#d1d1d150', borderBottomWidth: 1 }}>
