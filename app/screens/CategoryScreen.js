        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "#EFF7FC" }}>
            <View style={styles.header}>
                <View style={styles.flexRow}>
                    ...
                    <Text style={[styles.headerTitle]}>DAILY UTILITIES</Text>
                </View>
            </View>
                    ...
                    <View style={[styles.section]}>
                        <View style={[styles.categoryTitleImage]}>
                            <Image
                                ...
                                source={require("../assets/Handyman2x.png")}
                            />
                        </View>
                    </View>
                    <View style={[styles.section]}>
                        <View style={[styles.categoryservices]}>
                            ...
                            <View style={[styles.child]}>
                                {/* <View style={[styles.servicePopular], { backgroundColor: '#f6b700', alignItems: 'center', width: '70%', padding: 2 }}><Text style={[styles.servicePopularText], { color: '#fff', fontSize: 8 }}>POPULAR</Text></View> */}
                                <Image
                                    style={[styles.categoryServiceImage]}
                                    source={{
...
const styles = StyleSheet.create({
    ...
    categoryservices: {
        flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', marginVertical: 5
    },
