            ...
            <ScrollView style={styles.ScrollView}>
                        ...
                        <View
                            ...
                            title={
                                <View style={styles.homeBannerTextBox}>
                                    ...
                                    <Pressable style={styles.homeBannerButton} onPress={() => navigation.navigate('Offers')}>
                        ...
                        <View
                            ...
                            title={
                                <View style={styles.homeBannerTextBox}>
                                    ...
                                    <Pressable style={styles.homeBannerButton} onPress={() => navigation.navigate("GetGenie")}>
                                        <Text style={styles.homeBannerButtonText}>BOOK NOW</Text>
                                    </Pressable>
                                </View>
                            }
                ...
                <View style={[styles.section]}>
                    ...
                    <SwiperFlatList
                        ...
                        renderItem={({ item }) => (
                            <Pressable style={[styles.child]} onPress={() => navigation.navigate('GetGenie')}>
                                <Image
                ...
                <View style={styles.screen}>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={[styles.specialServiceAll]}>
                            <Pressable style={[styles.specialservicefirst, { marginTop: 20 }]} onPress={() => navigation.navigate('GetGenie')}>
                                <View
                                    style={{
                                ...
                                >
                                    <ImageBackground
                                        source={{
                                            uri: "https://iesoft.nyc3.cdn.digitaloceanspaces.com/homegenie/CovX-long-life-sanitisation20211009T08:26:08.jpg",
                                        }}
                                        style={{
                                            height: 250,
                                        }}
                            ...
                            <Pressable style={[styles.specialserviceSecond, { marginTop: 20 }]} onPress={() => navigation.navigate('GetGenie')}>
                                <View
                                    style={{
                                        borderBottomWidth: 10,
                                        borderColor: "#2eb0e4",
                                ...
                                >
                                    <Image
                                        ...
                                        source={{
                                            uri: "https://iesoft.nyc3.cdn.digitaloceanspaces.com/homegenie/Creative-Wrap-innovative-renovations20211116T18:13:44.jpg",
                                        }}
                                    />
                                </View>
                                <Text style={styles.textSpecialService}>
                            ...
                            <Pressable style={[styles.specialserviceThird]} onPress={() => navigation.navigate('GetGenie')}>
                                <SwiperFlatList
                                    autoplay={true}
                                    autoplayDelay={3}
                                    autoplayLoop={true}
